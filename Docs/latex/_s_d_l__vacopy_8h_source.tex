\doxysection{SDL\+\_\+vacopy.\+h}
\hypertarget{_s_d_l__vacopy_8h_source}{}\label{_s_d_l__vacopy_8h_source}\index{MonoRuntime/extern/sdl/src/stdlib/SDL\_vacopy.h@{MonoRuntime/extern/sdl/src/stdlib/SDL\_vacopy.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{comment}{//\ Do\ our\ best\ to\ make\ sure\ va\_copy\ is\ working}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#if\ (defined(\_MSC\_VER)\ \&\&\ \_MSC\_VER\ <=\ 1800)\ ||\ defined(\_\_SYMBIAN32\_\_)}}
\DoxyCodeLine{00024\ \textcolor{comment}{//\ Visual\ Studio\ 2013\ tries\ to\ link\ with\ \_vacopy\ in\ the\ C\ runtime.\ Newer\ versions\ do\ an\ inline\ assignment}}
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#undef\ va\_copy}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#define\ va\_copy(dst,\ src)\ dst\ =\ src}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#elif\ defined(\_\_GNUC\_\_)\ \&\&\ (\_\_GNUC\_\_\ <\ 3)}}
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#define\ va\_copy(dst,\ src)\ \_\_va\_copy(dst,\ src)}}
\DoxyCodeLine{00030\ }
