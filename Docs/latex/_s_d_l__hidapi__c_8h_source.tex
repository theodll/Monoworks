\doxysection{SDL\+\_\+hidapi\+\_\+c.\+h}
\hypertarget{_s_d_l__hidapi__c_8h_source}{}\label{_s_d_l__hidapi__c_8h_source}\index{MonoRuntime/extern/sdl/src/hidapi/SDL\_hidapi\_c.h@{MonoRuntime/extern/sdl/src/hidapi/SDL\_hidapi\_c.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{comment}{/*\ Return\ true\ if\ the\ HIDAPI\ should\ ignore\ a\ device\ during\ enumeration\ */}}
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ SDL\_HIDAPI\_ShouldIgnoreDevice(\textcolor{keywordtype}{int}\ bus\_type,\ Uint16\ vendor\_id,\ Uint16\ product\_id,\ Uint16\ usage\_page,\ Uint16\ usage,\ \textcolor{keywordtype}{bool}\ libusb,\ \textcolor{keywordtype}{bool}\ is\_xbox);}
\DoxyCodeLine{00026\ }
