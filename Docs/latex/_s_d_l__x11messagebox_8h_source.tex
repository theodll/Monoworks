\doxysection{SDL\+\_\+x11messagebox.\+h}
\hypertarget{_s_d_l__x11messagebox_8h_source}{}\label{_s_d_l__x11messagebox_8h_source}\index{MonoRuntime/extern/sdl/src/video/x11/SDL\_x11messagebox.h@{MonoRuntime/extern/sdl/src/video/x11/SDL\_x11messagebox.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#ifndef\ SDL\_x11messagebox\_h\_}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#define\ SDL\_x11messagebox\_h\_}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifdef\ SDL\_VIDEO\_DRIVER\_X11}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ X11\_ShowMessageBox(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_s_d_l___message_box_data}{SDL\_MessageBoxData}}\ *messageboxdata,\ \textcolor{keywordtype}{int}\ *buttonID);}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_VIDEO\_DRIVER\_X11}}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_x11messagebox\_h\_}}
