\doxysection{os.\+h}
\hypertarget{fmt_2bundled_2os_8h_source}{}\label{fmt_2bundled_2os_8h_source}\index{MonoEngine/thirdparty/spdlog/include/spdlog/fmt/bundled/os.h@{MonoEngine/thirdparty/spdlog/include/spdlog/fmt/bundled/os.h}}
...
\DoxyCodeLine{00076\ }
\DoxyCodeLine{00077\ FMT\_BEGIN\_NAMESPACE}
\DoxyCodeLine{00078\ FMT\_BEGIN\_EXPORT}
\DoxyCodeLine{00079\ }
\DoxyCodeLine{00096\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Char>\ \textcolor{keyword}{class\ }\doxymbox{\hyperlink{classbasic__cstring__view_ab464b2378652892cec4716d3e3d475c7}{basic\_cstring\_view}}\ \{}
...
\DoxyCodeLine{00102\ \ \ \doxymbox{\hyperlink{classbasic__cstring__view_ab464b2378652892cec4716d3e3d475c7}{basic\_cstring\_view}}(\textcolor{keyword}{const}\ Char*\ s)\ :\ data\_(s)\ \{\}}
\DoxyCodeLine{00103\ }
\DoxyCodeLine{00105\ \ \ \doxymbox{\hyperlink{classbasic__cstring__view_a10b92cc0e3e67789601984099b9ed339}{basic\_cstring\_view}}(\textcolor{keyword}{const}\ std::basic\_string<Char>\&\ s)\ :\ data\_(s.\doxymbox{\hyperlink{classbasic__cstring__view_afee1380c4722894a55b8b6895f6bf255}{c\_str}}())\ \{\}}
\DoxyCodeLine{00106\ }
\DoxyCodeLine{00108\ \ \ \textcolor{keyword}{auto}\ \doxymbox{\hyperlink{classbasic__cstring__view_afee1380c4722894a55b8b6895f6bf255}{c\_str}}()\ const\ -\/>\ const\ Char*\ \{\ \textcolor{keywordflow}{return}\ data\_;\ \}}
\DoxyCodeLine{00109\ \};}
\DoxyCodeLine{00110\ }
\DoxyCodeLine{00111\ \textcolor{keyword}{using\ }cstring\_view\ =\ \doxymbox{\hyperlink{classbasic__cstring__view}{basic\_cstring\_view<char>}};}
\DoxyCodeLine{00112\ \textcolor{keyword}{using\ }wcstring\_view\ =\ \doxymbox{\hyperlink{classbasic__cstring__view}{basic\_cstring\_view<wchar\_t>}};}
\DoxyCodeLine{00113\ }
\DoxyCodeLine{00114\ \textcolor{preprocessor}{\#ifdef\ \_WIN32}}
\DoxyCodeLine{00115\ FMT\_API\ \textcolor{keyword}{const}\ std::error\_category\&\ system\_category()\ noexcept;}
\DoxyCodeLine{00116\ }
\DoxyCodeLine{00117\ namespace\ \doxymbox{\hyperlink{namespacedetail}{detail}}\ \{}
\DoxyCodeLine{00118\ FMT\_API\ \textcolor{keywordtype}{void}\ format\_windows\_error(buffer<char>\&\ out,\ \textcolor{keywordtype}{int}\ error\_code,}
\DoxyCodeLine{00119\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ message)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00120\ \}}
\DoxyCodeLine{00121\ }
\DoxyCodeLine{00122\ FMT\_API\ std::system\_error\ vwindows\_error(\textcolor{keywordtype}{int}\ error\_code,\ string\_view\ fmt,}
\DoxyCodeLine{00123\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ format\_args\ args);}
\DoxyCodeLine{00124\ }
\DoxyCodeLine{00149\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00150\ \textcolor{keyword}{auto}\ windows\_error(\textcolor{keywordtype}{int}\ error\_code,\ string\_view\ message,\ \textcolor{keyword}{const}\ T\&...\ args)}
\DoxyCodeLine{00151\ \ \ \ \ -\/>\ std::system\_error\ \{}
\DoxyCodeLine{00152\ \ \ \textcolor{keywordflow}{return}\ vwindows\_error(error\_code,\ message,\ vargs<T...>\{\{args...\}\});}
\DoxyCodeLine{00153\ \}}
\DoxyCodeLine{00154\ }
...
\DoxyCodeLine{00166\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ S,\ \textcolor{keyword}{typename}...\ \doxymbox{\hyperlink{struct_args}{Args}},\ \textcolor{keyword}{typename}\ Char\ =\ char\_t<S>>}
\DoxyCodeLine{00167\ \textcolor{keywordtype}{void}\ say(\textcolor{keyword}{const}\ S\&\ fmt,\ \doxymbox{\hyperlink{struct_args}{Args}}\&\&...\ args)\ \{}
\DoxyCodeLine{00168\ \ \ std::system(format(\textcolor{stringliteral}{"{}say\ \(\backslash\)"{}\{\}\(\backslash\)"{}"{}},\ format(fmt,\ args...)).c\_str());}
\DoxyCodeLine{00169\ \}}
...
\DoxyCodeLine{00178\ }
\DoxyCodeLine{00179\ \ \ \textcolor{keyword}{inline}\ \textcolor{keyword}{explicit}\ buffered\_file(FILE*\ f)\ :\ file\_(f)\ \{\}}
\DoxyCodeLine{00180\ }
...
\DoxyCodeLine{00186\ \ \ \textcolor{keyword}{inline}\ buffered\_file()\ noexcept\ :\ file\_(\textcolor{keyword}{nullptr})\ \{\}}
\DoxyCodeLine{00187\ }
...
\DoxyCodeLine{00192\ \ \ \textcolor{keyword}{inline}\ buffered\_file(buffered\_file\&\&\ other)\ noexcept\ :\ file\_(other.file\_)\ \{}
\DoxyCodeLine{00193\ \ \ \ \ other.file\_\ =\ \textcolor{keyword}{nullptr};}
\DoxyCodeLine{00194\ \ \ \}}
\DoxyCodeLine{00195\ }
\DoxyCodeLine{00196\ \ \ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ operator=(buffered\_file\&\&\ other)\ -\/>\ buffered\_file\&\ \{}
...
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ get()\ \textcolor{keyword}{const}\ \textcolor{keyword}{noexcept}\ -\/>\ FILE*\ \{\ \textcolor{keywordflow}{return}\ file\_;\ \}}
\DoxyCodeLine{00211\ }
...
\DoxyCodeLine{00216\ \ \ \ \ fmt::vargs<T...>\ vargs\ =\ \{\{args...\}\};}
...
\DoxyCodeLine{00323\ }
\DoxyCodeLine{00324\ \textcolor{keyword}{namespace\ }\doxymbox{\hyperlink{namespacedetail}{detail}}\ \{}
\DoxyCodeLine{00325\ }
...
\DoxyCodeLine{00329\ \ \ FMT\_CONSTEXPR\ \textcolor{keyword}{auto}\ operator=(\textcolor{keywordtype}{size\_t}\ val)\ \textcolor{keyword}{const}\ -\/>\ buffer\_size\ \{}
...
\DoxyCodeLine{00362\ }
\DoxyCodeLine{00363\ FMT\_INLINE\_VARIABLE\ \textcolor{keyword}{constexpr}\ \textcolor{keyword}{auto}\ buffer\_size\ =\ detail::buffer\_size();}
\DoxyCodeLine{00364\ }
\DoxyCodeLine{00367\ \textcolor{keyword}{class\ }ostream\ :\ \textcolor{keyword}{private}\ \doxymbox{\hyperlink{classdetail_1_1buffer}{detail::buffer}}<char>\ \{}
\DoxyCodeLine{00368\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00369\ \ \ file\ file\_;}
\DoxyCodeLine{00370\ }
\DoxyCodeLine{00371\ \ \ FMT\_API\ ostream(cstring\_view\ path,\ \textcolor{keyword}{const}\ detail::ostream\_params\&\ params);}
\DoxyCodeLine{00372\ }
\DoxyCodeLine{00373\ \ \ FMT\_API\ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ grow(buffer<char>\&\ buf,\ \textcolor{keywordtype}{size\_t});}
\DoxyCodeLine{00374\ }
\DoxyCodeLine{00375\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00376\ \ \ FMT\_API\ ostream(ostream\&\&\ other)\ \textcolor{keyword}{noexcept};}
\DoxyCodeLine{00377\ \ \ FMT\_API\ \string~ostream();}
\DoxyCodeLine{00378\ }
...
\DoxyCodeLine{00382\ \ \ \}}
\DoxyCodeLine{00383\ }
\DoxyCodeLine{00384\ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ flush()\ \{}
\DoxyCodeLine{00385\ \ \ \ \ \textcolor{keywordflow}{if}\ (\doxymbox{\hyperlink{classdetail_1_1buffer_a8685285932360c284d19003fc4ba3edc}{size}}()\ ==\ 0)\ \textcolor{keywordflow}{return};}
\DoxyCodeLine{00386\ \ \ \ \ file\_.write(\doxymbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}(),\ \doxymbox{\hyperlink{classdetail_1_1buffer_a8685285932360c284d19003fc4ba3edc}{size}}()\ *\ \textcolor{keyword}{sizeof}(\doxymbox{\hyperlink{classdetail_1_1buffer_aeb33e0a2d2be2bbca9e0236c148089c8}{data}}()[0]));}
\DoxyCodeLine{00387\ \ \ \ \ \doxymbox{\hyperlink{classdetail_1_1buffer_af53aad71d2441a653570f07d76db1844}{clear}}();}
\DoxyCodeLine{00388\ \ \ \}}
\DoxyCodeLine{00389\ }
\DoxyCodeLine{00390\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00391\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{auto}\ output\_file(cstring\_view\ path,\ T...\ params)\ -\/>\ ostream;}
\DoxyCodeLine{00392\ }
\DoxyCodeLine{00393\ \ \ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ close()\ \{}
\DoxyCodeLine{00394\ \ \ \ \ flush();}
\DoxyCodeLine{00395\ \ \ \ \ file\_.close();}
\DoxyCodeLine{00396\ \ \ \}}
\DoxyCodeLine{00397\ }
\DoxyCodeLine{00400\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>\ \textcolor{keywordtype}{void}\ print(format\_string<T...>\ fmt,\ T\&\&...\ args)\ \{}
\DoxyCodeLine{00401\ \ \ \ \ vformat\_to(appender(*\textcolor{keyword}{this}),\ fmt.str,\ vargs<T...>\{\{args...\}\});}
\DoxyCodeLine{00402\ \ \ \}}
\DoxyCodeLine{00403\ \};}
\DoxyCodeLine{00404\ }
\DoxyCodeLine{00418\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ T>}
\DoxyCodeLine{00419\ \textcolor{keyword}{inline}\ \textcolor{keyword}{auto}\ output\_file(cstring\_view\ path,\ T...\ params)\ -\/>\ ostream\ \{}
...
\DoxyCodeLine{00423\ }
\DoxyCodeLine{00424\ FMT\_END\_EXPORT}
\DoxyCodeLine{00425\ FMT\_END\_NAMESPACE}
\DoxyCodeLine{00426\ }
