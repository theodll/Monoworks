\doxysection{SDL\+\_\+gdk.\+h}
\hypertarget{_s_d_l__gdk_8h_source}{}\label{_s_d_l__gdk_8h_source}\index{MonoRuntime/extern/sdl/src/core/gdk/SDL\_gdk.h@{MonoRuntime/extern/sdl/src/core/gdk/SDL\_gdk.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{comment}{//\ This\ is\ called\ from\ WIN\_PumpEvents\ on\ GDK}}
\DoxyCodeLine{00024\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ GDK\_DispatchTaskQueue(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ GDK\_RegisterChangeNotifications(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ GDK\_UnregisterChangeNotifications(\textcolor{keywordtype}{void});}
