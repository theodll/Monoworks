\doxysection{SDL\+\_\+androidtouch.\+h}
\hypertarget{_s_d_l__androidtouch_8h_source}{}\label{_s_d_l__androidtouch_8h_source}\index{MonoRuntime/extern/sdl/src/video/android/SDL\_androidtouch.h@{MonoRuntime/extern/sdl/src/video/android/SDL\_androidtouch.h}}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_InitTouch(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_QuitTouch(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_OnTouch(\doxymbox{\hyperlink{struct_s_d_l___window}{SDL\_Window}}\ *window,\ \textcolor{keywordtype}{int}\ touch\_device\_id\_in,\ \textcolor{keywordtype}{int}\ pointer\_finger\_id\_in,\ \textcolor{keywordtype}{int}\ action,\ \textcolor{keywordtype}{float}\ x,\ \textcolor{keywordtype}{float}\ y,\ \textcolor{keywordtype}{float}\ p);}
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ SDL\_TouchID\ Android\_ConvertJavaTouchID(\textcolor{keywordtype}{int}\ touchID);}
