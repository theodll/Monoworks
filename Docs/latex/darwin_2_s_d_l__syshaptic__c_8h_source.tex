\doxysection{SDL\+\_\+syshaptic\+\_\+c.\+h}
\hypertarget{darwin_2_s_d_l__syshaptic__c_8h_source}{}\label{darwin_2_s_d_l__syshaptic__c_8h_source}\index{MonoRuntime/extern/sdl/src/haptic/darwin/SDL\_syshaptic\_c.h@{MonoRuntime/extern/sdl/src/haptic/darwin/SDL\_syshaptic\_c.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{comment}{//\ Things\ named\ "{}Master"{}\ were\ renamed\ to\ "{}Main"{}\ in\ macOS\ 12.0's\ SDK.}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#include\ <AvailabilityMacros.h>}}
\DoxyCodeLine{00024\ \textcolor{preprocessor}{\#if\ MAC\_OS\_X\_VERSION\_MIN\_REQUIRED\ <\ 120000}}
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#define\ kIOMainPortDefault\ kIOMasterPortDefault}}
\DoxyCodeLine{00026\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ MacHaptic\_MaybeAddDevice(io\_object\_t\ device);}
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ MacHaptic\_MaybeRemoveDevice(io\_object\_t\ device);}
