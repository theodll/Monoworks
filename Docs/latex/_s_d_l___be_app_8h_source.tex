\doxysection{SDL\+\_\+\+Be\+App.\+h}
\hypertarget{_s_d_l___be_app_8h_source}{}\label{_s_d_l___be_app_8h_source}\index{MonoRuntime/extern/sdl/src/core/haiku/SDL\_BeApp.h@{MonoRuntime/extern/sdl/src/core/haiku/SDL\_BeApp.h}}
...
\DoxyCodeLine{00026\ \textcolor{comment}{//\ Handle\ the\ BeApp\ specific\ portions\ of\ the\ application}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{comment}{//\ Initialize\ the\ Be\ Application,\ if\ it's\ not\ already\ started}}
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ SDL\_InitBeApp(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{comment}{//\ Quit\ the\ Be\ Application,\ if\ there's\ nothing\ left\ to\ do}}
\DoxyCodeLine{00032\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ SDL\_QuitBeApp(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{comment}{//\ Be\ Application\ Signature}}
\DoxyCodeLine{00035\ \textcolor{keyword}{extern}\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *SDL\_signature;}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ }
