\doxysection{SDL\+\_\+ngage.\+h}
\hypertarget{_s_d_l__ngage_8h_source}{}\label{_s_d_l__ngage_8h_source}\index{MonoRuntime/extern/sdl/src/core/ngage/SDL\_ngage.h@{MonoRuntime/extern/sdl/src/core/ngage/SDL\_ngage.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#ifndef\ SDL\_ngage\_h}}
\DoxyCodeLine{00024\ \textcolor{preprocessor}{\#define\ SDL\_ngage\_h}}
\DoxyCodeLine{00025\ }
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{keywordtype}{bool}\ NGAGE\_IsClassicModel();}
\DoxyCodeLine{00031\ \textcolor{keywordtype}{void}\ NGAGE\_DebugPrintf(SDL\_PRINTF\_FORMAT\_STRING\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *fmt,\ ...)\ SDL\_PRINTF\_VARARG\_FUNC(1);}
\DoxyCodeLine{00032\ }
\DoxyCodeLine{00033\ \textcolor{preprocessor}{\#ifdef\ \_\_cplusplus}}
\DoxyCodeLine{00034\ \}}
\DoxyCodeLine{00035\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{/*\ SDL\_ngage\_h\ */}\textcolor{preprocessor}{}}
