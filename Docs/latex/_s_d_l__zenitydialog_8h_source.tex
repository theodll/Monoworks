\doxysection{SDL\+\_\+zenitydialog.\+h}
\hypertarget{_s_d_l__zenitydialog_8h_source}{}\label{_s_d_l__zenitydialog_8h_source}\index{MonoRuntime/extern/sdl/src/dialog/unix/SDL\_zenitydialog.h@{MonoRuntime/extern/sdl/src/dialog/unix/SDL\_zenitydialog.h}}
...
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ SDL\_Zenity\_ShowFileDialogWithProperties(SDL\_FileDialogType\ type,\ SDL\_DialogFileCallback\ callback,\ \textcolor{keywordtype}{void}\ *userdata,\ SDL\_PropertiesID\ props);}
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ SDL\_Zenity\_detect(\textcolor{keywordtype}{void});}
