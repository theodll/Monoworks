\doxysection{SDL\+\_\+sysstdlib.\+h}
\hypertarget{_s_d_l__sysstdlib_8h_source}{}\label{_s_d_l__sysstdlib_8h_source}\index{MonoRuntime/extern/sdl/src/stdlib/SDL\_sysstdlib.h@{MonoRuntime/extern/sdl/src/stdlib/SDL\_sysstdlib.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#ifndef\ SDL\_sysstdlib\_h\_}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#define\ SDL\_sysstdlib\_h\_}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{comment}{//\ most\ things\ you\ might\ need\ internally\ in\ here\ are\ public\ APIs,\ this\ is}}
\DoxyCodeLine{00026\ \textcolor{comment}{//\ just\ a\ few\ special\ pieces\ right\ now.}}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{comment}{//\ this\ expects\ \`{}from`\ to\ be\ a\ Unicode\ codepoint,\ and\ \`{}to`\ to\ point\ to\ AT\ LEAST\ THREE\ Uint32s.}}
\DoxyCodeLine{00029\ \textcolor{keywordtype}{int}\ SDL\_CaseFoldUnicode(Uint32\ from,\ Uint32\ *to);}
\DoxyCodeLine{00030\ }
