\doxysection{SDL\+\_\+windowsmessagebox.\+h}
\hypertarget{_s_d_l__windowsmessagebox_8h_source}{}\label{_s_d_l__windowsmessagebox_8h_source}\index{MonoRuntime/extern/sdl/src/video/windows/SDL\_windowsmessagebox.h@{MonoRuntime/extern/sdl/src/video/windows/SDL\_windowsmessagebox.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#ifdef\ SDL\_VIDEO\_DRIVER\_WINDOWS}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ WIN\_ShowMessageBox(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_s_d_l___message_box_data}{SDL\_MessageBoxData}}\ *messageboxdata,\ \textcolor{keywordtype}{int}\ *buttonID);}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_VIDEO\_DRIVER\_WINDOWS}}
