\doxysection{SDL\+\_\+uikitmessagebox.\+h}
\hypertarget{_s_d_l__uikitmessagebox_8h_source}{}\label{_s_d_l__uikitmessagebox_8h_source}\index{MonoRuntime/extern/sdl/src/video/uikit/SDL\_uikitmessagebox.h@{MonoRuntime/extern/sdl/src/video/uikit/SDL\_uikitmessagebox.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#ifdef\ SDL\_VIDEO\_DRIVER\_UIKIT}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ UIKit\_ShowingMessageBox(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ UIKit\_ShowMessageBox(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_s_d_l___message_box_data}{SDL\_MessageBoxData}}\ *messageboxdata,\ \textcolor{keywordtype}{int}\ *buttonID);}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_VIDEO\_DRIVER\_UIKIT}}
