...
\hypertarget{android_2_s_d_l__syshaptic__c_8h_source}{}\label{android_2_s_d_l__syshaptic__c_8h_source}\index{MonoRuntime/extern/sdl/src/haptic/android/SDL\_syshaptic\_c.h@{MonoRuntime/extern/sdl/src/haptic/android/SDL\_syshaptic\_c.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#ifdef\ SDL\_HAPTIC\_ANDROID}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ Android\_AddHaptic(\textcolor{keywordtype}{int}\ device\_id,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *name);}
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ Android\_RemoveHaptic(\textcolor{keywordtype}{int}\ device\_id);}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_HAPTIC\_ANDROID}}
