\doxysection{SDL\+\_\+androidmouse.\+h}
\hypertarget{_s_d_l__androidmouse_8h_source}{}\label{_s_d_l__androidmouse_8h_source}\index{MonoRuntime/extern/sdl/src/video/android/SDL\_androidmouse.h@{MonoRuntime/extern/sdl/src/video/android/SDL\_androidmouse.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#ifndef\ SDL\_androidmouse\_h\_}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#define\ SDL\_androidmouse\_h\_}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#include\ "{}SDL\_androidvideo.h"{}}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_InitMouse(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00028\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_OnMouse(\doxymbox{\hyperlink{struct_s_d_l___window}{SDL\_Window}}\ *window,\ \textcolor{keywordtype}{int}\ button,\ \textcolor{keywordtype}{int}\ action,\ \textcolor{keywordtype}{float}\ x,\ \textcolor{keywordtype}{float}\ y,\ \textcolor{keywordtype}{bool}\ relative);}
\DoxyCodeLine{00029\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_QuitMouse(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_androidmouse\_h\_}}
