...
\hypertarget{uikit_2_s_d_l__syspower_8h_source}{}\label{uikit_2_s_d_l__syspower_8h_source}\index{MonoRuntime/extern/sdl/src/power/uikit/SDL\_syspower.h@{MonoRuntime/extern/sdl/src/power/uikit/SDL\_syspower.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#ifdef\ SDL\_POWER\_UIKIT}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{keywordtype}{void}\ SDL\_UIKit\_UpdateBatteryMonitoring(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00026\ \textcolor{keywordtype}{bool}\ SDL\_GetPowerInfo\_UIKit(SDL\_PowerState\ *state,\ \textcolor{keywordtype}{int}\ *seconds,\ \textcolor{keywordtype}{int}\ *percent);}
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_POWER\_UIKIT}}
