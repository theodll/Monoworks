\doxysection{SDL\+\_\+androidevents.\+h}
\hypertarget{_s_d_l__androidevents_8h_source}{}\label{_s_d_l__androidevents_8h_source}\index{MonoRuntime/extern/sdl/src/video/android/SDL\_androidevents.h@{MonoRuntime/extern/sdl/src/video/android/SDL\_androidevents.h}}
...
\DoxyCodeLine{00022\ }
\DoxyCodeLine{00023\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_InitEvents(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00024\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_PumpEvents(Sint64\ timeoutNS);}
\DoxyCodeLine{00025\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ Android\_WaitActiveAndLockActivity(\textcolor{keywordtype}{void});}
\DoxyCodeLine{00026\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{void}\ Android\_QuitEvents(\textcolor{keywordtype}{void});}
