\doxysection{SDL\+\_\+vitamessagebox.\+h}
\hypertarget{_s_d_l__vitamessagebox_8h_source}{}\label{_s_d_l__vitamessagebox_8h_source}\index{MonoRuntime/extern/sdl/src/video/vita/SDL\_vitamessagebox.h@{MonoRuntime/extern/sdl/src/video/vita/SDL\_vitamessagebox.h}}
...
\DoxyCodeLine{00021\ }
\DoxyCodeLine{00022\ \textcolor{preprocessor}{\#ifndef\ SDL\_vitamessagebox\_h\_}}
\DoxyCodeLine{00023\ \textcolor{preprocessor}{\#define\ SDL\_vitamessagebox\_h\_}}
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \textcolor{preprocessor}{\#ifdef\ SDL\_VIDEO\_DRIVER\_VITA}}
\DoxyCodeLine{00026\ }
\DoxyCodeLine{00027\ \textcolor{keyword}{extern}\ \textcolor{keywordtype}{bool}\ VITA\_ShowMessageBox(\textcolor{keyword}{const}\ \doxymbox{\hyperlink{struct_s_d_l___message_box_data}{SDL\_MessageBoxData}}\ *messageboxdata,\ \textcolor{keywordtype}{int}\ *buttonID);}
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_VIDEO\_DRIVER\_VITA}}
\DoxyCodeLine{00030\ }
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ SDL\_vitamessagebox\_h\_}}
