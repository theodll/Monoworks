\doxysection{SDL\+\_\+portaldialog.\+h}
\hypertarget{_s_d_l__portaldialog_8h_source}{}\label{_s_d_l__portaldialog_8h_source}\index{MonoRuntime/extern/sdl/src/dialog/unix/SDL\_portaldialog.h@{MonoRuntime/extern/sdl/src/dialog/unix/SDL\_portaldialog.h}}
...
\DoxyCodeLine{00023\ }
\DoxyCodeLine{00024\ \textcolor{keywordtype}{void}\ SDL\_Portal\_ShowFileDialogWithProperties(SDL\_FileDialogType\ type,\ SDL\_DialogFileCallback\ callback,\ \textcolor{keywordtype}{void}\ *userdata,\ SDL\_PropertiesID\ props);}
\DoxyCodeLine{00025\ }
\DoxyCodeLine{00027\ \textcolor{keywordtype}{bool}\ SDL\_Portal\_detect(\textcolor{keywordtype}{void});}
