\chapter{AGENTS }
\hypertarget{md__mono_runtime_2extern_2sdl_2_a_g_e_n_t_s}{}\label{md__mono_runtime_2extern_2sdl_2_a_g_e_n_t_s}\index{AGENTS@{AGENTS}}
AI must not be used to generate code for contributions to this project.

"{}\+AI"{} in this case means a Large Language Model ("{}\+LLM"{}), such as Chat\+GPT, Claude, Copilot, Grok, etc.
