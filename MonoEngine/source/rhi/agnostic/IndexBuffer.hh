...
namespace Monoworks::RHI
{
    ...
    public:
        ...
        NODISCARD static Ref<IIndexBuffer> Create( u32 size ) NOEXCEPT;
        NODISCARD static Ref<IIndexBuffer> Create( void* pData, u32 size, u32 offset = 0, bool autoupload = false ) NOEXCEPT;
    };
}