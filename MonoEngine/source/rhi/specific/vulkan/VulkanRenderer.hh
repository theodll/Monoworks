...
namespace Monoworks::RHI
{
    ...
    class CVulkanRenderer final : public IGraphicsAPI
    {
        ...
        MW_NOTHROW void Present( u32 frameIndex ) NOEXCEPT override;
        ...
        MW_NOTHROW void DrawStaticMeshIndexed(  u32 frameIndex, Ref<CMesh> hMesh, const Matrix& transform ) NOEXCEPT override;
